        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{url('author')}}">PUBLISHERS/AUTHORS</a>
              </li>
      ...
      <div class="owl-banner owl-carousel">
        <div class="banner-item-01">
          <div class="text-content">
            <h4>AZIMA KITABU</h4>
            <h2>ONGEZA UFIKIRI</h2>
          </div>
        </div>
        <div class="banner-item-02">
          <div class="text-content">
            <h4>Vitabu Aina Zote</h4>
            <h2>kwa ufikiri wako</h2>
          </div>
        </div>
        <div class="banner-item-03">
          <div class="text-content">
            <h4>soma vitabu leo</h4>
            <h2>kwa afya ya ubongo wako</h2>
          </div>
        </div>
      </div>
    </div>
